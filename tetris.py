...
hold_rect = pygame.Rect(320, 430, 170, 180)  # New hold block area
...
# Score multipliers for different difficulties
EASY_SCORE_MULTIPLIER = 0.75
NORMAL_SCORE_MULTIPLIER = 1
HARD_SCORE_MULTIPLIER = 3
...
base_speed = 250  # Base speed in milliseconds
